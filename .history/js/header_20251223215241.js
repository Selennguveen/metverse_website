...
class HeaderManager {
     ...
     * Giriş yapılmış influencer kullanıcı premium paketine sahip değilse uyarı ver
     */
            ...
            link.addEventListener('click', (e) => {
                ...
                if (user) {
                    try {
                        ...
                        console.log('📦 Paket:', userData.paket);
                        
                        // Influencer ise ve paket ucretsiz ise, uyarı ver
                        if (userData.userType === 'influencer' && userData.paket === 'ucretsiz') {
                            e.preventDefault();
                            e.stopPropagation();
                            
                            console.log('❌ Uyarı gösteriliyor');
                            alert('📊 Analizler Premium Özelliğidir\n\n' +
                                  'Bu özelliği kullanmak için Premium paketine geçmeniz gerekiyor.\n' +
                                  'Paketinizi yükseltmek için Profil > Hesabı Tamamla bölümünden güncelleyebilirsiniz.\n\n' +
                                  'Premium Paket Fiyatı: ₺650/ay');
                            
                            return false;
                        } else {
                            console.log('✅ Premium paketli veya marka kullanıcı, erişime izin ver');
                        }
                    } catch (error) {
