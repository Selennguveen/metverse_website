            ...
            link.addEventListener('click', (e) => {
                ...
                if (user) {
                    try {
                        ...
                        if (userData.paket === 'ucretsiz' || userData.paket === undefined) {
                            e.preventDefault();
                            e.stopPropagation();
                    ...
                    <div class="modal-container hesabi-yuksel-modal" style="max-width: 500px;">
                        ...
                        <div class="modal-content hesabi-yuksel-content">
                            ...
                            <div style="display: flex; gap: 10px; margin-top: 20px;">
                                <button id="yukselIptalBtn" class="form-submit-btn" style="flex: 1; background: #555;">İptal</button>
                                <button id="yukselOdeBtn" class="form-submit-btn" style="flex: 1; background: #e885ca;">₺1.200 Öde</button>
                            </div>
                        </div>
                    </div>
                </div>
