...
app.post('/api/register-influencer', async (req, res) => {
    const { ad, soyad, email, sifre, telefon, kosullarKabul, paket } = req.body;
    
    console.log('📨 /api/register-influencer REQUEST:', { ad, soyad, email, telefon, kosullarKabul, paket });
    
    if (!ad || !soyad || !email || !sifre || !telefon || !kosullarKabul) {
        console.log('❌ Validation failed:', { ad: !!ad, soyad: !!soyad, email: !!email, sifre: !!sifre, telefon: !!telefon, kosullarKabul: !!kosullarKabul });
