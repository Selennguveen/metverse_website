...
app.post('/api/teklif-kabul', (req, res) => {
    try {
        ...
        console.log('✅ Teklif kabul edildi. Kampanya eklendi:', kampanya.kampanya_adi);
        res.json({ success: true, message: 'Teklif kabul edildi.', kampanya });
    } catch (error) {
