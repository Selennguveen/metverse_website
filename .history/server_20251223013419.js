...
app.post('/api/kayit', async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ id: newInfluencer.id, email }, JWT_SECRET, { expiresIn: '24h' });
        res.json({ success: true, message: '✅ İnfluencer kaydı başarılı.', token, user: { id: newInfluencer.id, ad, soyad, email, telefon, paket: paket || 'ucretsiz', userType: 'influencer' } });
